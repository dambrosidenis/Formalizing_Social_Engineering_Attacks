...
\begin{definition}[Protocol rules]
    ...
    \begin{enumerate}
        ...
        \item The argument of any $\mono{Fr}$ fact belongs to set of fresh terms
        ...
        \begin{itemize}
            ...
            \item $l$ only contains irreducible function symbols from the given signature or it is an instance if a rule that satisfies both conditions
        \end{itemize}
    \end{enumerate}
\end{definition}
